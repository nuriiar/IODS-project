...
keep1 <- c("Tea", "How", "how", "sugar", "where", "lunch")
tea_time <- select(tea, one_of(keep1))
head(tea_time)
...
Yet, from the plot we see that a lot of values are graphically proximate to each other, values such as earl gray, black, not.lunch, alone, no.sugar lunch, lemon, milk are quite close considering both x and y axes. 